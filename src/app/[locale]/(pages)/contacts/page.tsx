...
const Contacts = async ({
  ...
  return (
    <div>
      <div style={{ width: "100%" }}>
        <img src="/2-2.jpg" alt="Contacts" width="100%" height="auto" />
        ...
        <div style={{ width: "100%", height: "100%" }}>
          <div className="contact_plank">
            <div style={{ padding: "2%" }}>
              ...
              />
              <a href="tel:+97688109099" style={{ textDecoration: "none" }}>
                +976-88109099
                <br />
              </a>
              <a href="tel:+97689750308" style={{ textDecoration: "none" }}>
                +976-89750308
              </a>
            </div>
            <div style={{ padding: "2%" }}>
              ...
              />
              <a
                href="mailto:info@saibaitour.mn"
            ...
            <div style={{ padding: "2%" }}>
              ...
              />
              <p>
                16093-0024, 9 khoroo, 3-2 building,
                <br />
      ...
      <div id="targetBlock" className="visibility_area">
        ...
        <p className="contact_text" style={{ textAlign: "center" }}>
          {t("third")}
        </p>
        <div className="visibility_area">
          <InputForm
