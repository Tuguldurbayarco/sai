...
const About = async ({
  ...
  return (
    <div>
      <div>
        <img src="/bt0.jpg" alt="Name" width="100%" />
      ...
      <div className="visibility_area">
        ...
        <div style={{ justifyContent: "center", textAlign: "justify" }}>
          ...
          <div>
            <h2 style={{ marginBottom: "2%" }} className="about_titles">
              {t("vehicle")}
            </h2>
            <CarsSlider />
          ...
          <div>
            <h2 className="about_titles" style={{ marginTop: "3%" }}>
              ACCREDITATION
            </h2>
            <img
              src="/cert.png"
